...
We then use the `plot()` function to create a graph that shows the CV error associated with each value of $\lambda$.
...
We now perform cross-validation, plot the estimated test MSE for each lambda, and use the test set to estimate the test error for the model with the optimal $\lambda$.
